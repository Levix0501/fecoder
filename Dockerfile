...
FROM registry.cn-hangzhou.aliyuncs.com/levix/slim AS dependencies
...
FROM registry.cn-hangzhou.aliyuncs.com/levix/slim AS builder
WORKDIR /fecoder
...
FROM registry.cn-hangzhou.aliyuncs.com/levix/slim AS runner
WORKDIR /fecoder
