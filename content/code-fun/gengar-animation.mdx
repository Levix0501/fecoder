---
slug: gengar-animation
cover: cm0l0ambi0000g3ejuv3qhrxg
title: 捕捉一只耿鬼
description: 这是一个 HTML 文件展示了一个耿鬼的动态效果。通过 CSS 实现了耿鬼的各种特征，包括耳朵、眼睛、嘴巴和手臂的动画。当用户勾选复选框时，耿鬼的眼睛和嘴巴会发生变化，增加了互动性和趣味性。页面背景为白色，整体风格简洁易读。
keywords: 耿鬼动画, CSS耿鬼, 动态耿鬼, 耿鬼效果, 动画角色, 耿鬼动态, 网络动画, CSS动画, Pokémon耿鬼
date: 2024-08-01
mobile: false
---
