---
slug: interactive-light-switch
cover: cm0l30zp50000uo8vmpv3wr1c
title: 开灯！关灯！
description: 这个页面包含简单的灯控制功能示例，展示了如何使用前端技术实现交互式按钮来开关灯。适合学习和了解基础的前端交互设计。
keywords: 前端技术, 交互设计, 开关灯, HTML示例, JavaScript, CSS, 用户界面
date: 2024-08-18
mobile: true
---
