---
slug: bubble-gum-animation
cover:
title: 喜欢喝雪碧还是可乐
description: 这是一个前端技术示例网页，展示了使用CSS动画和HTML构建的动态饮料效果。页面包含两个玻璃杯，分别代表雪碧和可乐，通过CSS实现了逼真的波浪和气泡动画效果，适合用于学习和探索现代前端动画技术。
keywords: 前端技术, CSS动画, HTML示例, 动态效果, 网页设计, 雪碧动画, 可乐动画, 波浪动画, 气泡效果, 网页开发
date: 2024-08-24
mobile: true
---
  ...
  <head>
    ...
    <style>
      ...
      .wave {
        ...
        height: 100%;
        clip-path: path(
          'M0,124V2.71c122.49-10.81,209.27,15.25,320,0v121.29H0Z'
        );
      ...
      .wave::before {
        top: 0%;
        clip-path: path(
          'M0,1.15v78.25h320V1.15C206.2-3.87,122.14,9.73,0,1.15Z'
        );
      ...
      .glass.soda .wave {
        ...
        background-image: radial-gradient(
            at 15% 25%,
            hsla(197, 71%, 55%, 0.53) 0px,
            transparent 50%
          ), radial-gradient(
            at 78% 30%,
            hsla(178, 100%, 77%, 0.73) 0px,
            transparent 50%
          ), radial-gradient(
            at 94% 92%,
            hsla(210, 97%, 57%, 0.84) 0px,
            transparent 50%
          ), radial-gradient(
            at 11% 87%,
            hsla(176, 100%, 52%, 0.63) 0px,
            transparent 50%
          ), radial-gradient(at 45% 86%, hsla(178, 75%, 49%, 0.63) 0px, transparent
              50%);
      }
      .glass.soda .wave::before {
        ...
        background-image: radial-gradient(
            ...
            hsla(176, 100%, 52%, 0.63) 0px,
            transparent 50%
          ), radial-gradient(at 16% 29%, hsla(178, 75%, 49%, 0.63) 0px, transparent
              50%);
      }
      .glass.soda .wave::after {
        background-image: radial-gradient(
            ...
            hsla(176, 100%, 52%, 0.63) 0px,
            transparent 50%
          ), radial-gradient(at 60% 89%, hsla(178, 75%, 49%, 0.63) 0px, transparent
              50%);
      }
      .glass.cola .wave {
        ...
        background-image: radial-gradient(
            at 25% 51%,
            hsla(18, 74%, 47%, 0.53) 0px,
            transparent 50%
          ), radial-gradient(
            at 69% 48%,
            hsla(18, 100%, 60%, 0.73) 0px,
            transparent 50%
          ), radial-gradient(
            at 9% 94%,
            hsla(18, 77%, 20%, 0.84) 0px,
            transparent 50%
          ), radial-gradient(
            at 90% 90%,
            hsla(0, 88%, 18%, 0.63) 0px,
            transparent 50%
          ), radial-gradient(at 60% 89%, hsla(0, 52%, 64%, 0.63) 0px, transparent
              50%);
      }
      .glass.cola .wave::before {
        ...
        background-image: radial-gradient(
            ...
            at 12% 18%,
            hsla(18, 56%, 48%, 0.84) 0px,
            transparent 50%
          ), radial-gradient(
            at 22% 81%,
            hsla(5, 73%, 54%, 0.63) 0px,
            transparent 50%
          ), radial-gradient(at 75% 82%, hsla(0, 52%, 64%, 0.63) 0px, transparent
              50%);
      }
      .glass.cola .wave::after {
        ...
        background-image: radial-gradient(
            ...
            at 76% 24%,
            hsla(14, 73%, 30%, 0.93) 0px,
            transparent 50%
          ), radial-gradient(
            at 48% 94%,
            hsla(1, 53%, 32%, 0.92) 0px,
            transparent 50%
          ), radial-gradient(
            at 12% 95%,
            hsla(0, 52%, 21%, 0.86) 0px,
            transparent 50%
          ), radial-gradient(
            at 12% 16%,
            hsla(0, 47%, 36%, 0.94) 0px,
            transparent 50%
          ), radial-gradient(at 30% 45%, hsla(0, 52%, 64%, 0.63) 0px, transparent
              50%);
      }
      ...
      @keyframes wave1 {
        ...
        50% {
          clip-path: path(
            'M0,123.96V2.66c122.28,13.91,215.81-10.38,320,0v121.29H0Z'
          );
        }
        100% {
          clip-path: path(
      ...
      @keyframes wave2 {
        ...
        50% {
          clip-path: path(
            'M0,1.75v78.25h320V1.75C209.27,11.59,122.49-5.22,0,1.75Z'
          );
        }
        100% {
          clip-path: path(
