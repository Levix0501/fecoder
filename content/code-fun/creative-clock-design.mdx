---
title: 好看的摆钟
description: 这是一款前端技术开发的创意时钟网页，包含模拟摆钟和数字时钟，使用HTML、CSS和JavaScript实现。网页中的摆钟具有动态旋转效果，数字时钟精确显示时间并支持AM/PM格式转换，是一个展示前端动画效果的优秀例子，适合前端开发者学习和借鉴。
keywords: 前端开发, HTML, CSS, JavaScript, 摆钟动画, 数字时钟, 网页设计, 动态效果, AM/PM格式, 时钟展示, 创意网页
date: 2024-08-25
---
  ...
  <head>
    ...
    <style>
      @font-face {
        ...
        font-weight: 400;
        font-display: swap;
        src: url(https://www.fecoder.cn/code-fun/fonts/nwpTtK2nIhxE0q-IwgSpZBqyyCg_SsDV7Cd_.woff2)
          format('woff2');
